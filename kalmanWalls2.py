...
A = np.array([
    ...
    [0, 0, 0, 0, 0, 0, dt, 0, 0],          # x_velocity updated with drag
    [0, 0, 0, 0, 0, 0, 0, dt, 0],          # y_velocity updated with drag
    [0, 0, 0, 0, 0, 0, 0, 0, dt],         # angular_velocity updated with drag
...
while True:
    ...
    # Predict step
    predict_control  = control_inputs# np.array([[linear_velocity * math.cos(orientation_rad) ], [linear_velocity* math.sin(orientation_rad)]])
